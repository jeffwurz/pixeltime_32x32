...
void loop() {
  scroll_text(5,100,"@JEFFWURZ",10,10,90);
  display.clearDisplay();
  ...
  {
    display.drawLine(xx+14,0,xx+14,5,display.color565(xx*4+4,0,0));
    display.drawLine(xx+14,6,xx+14,10,display.color565(0,xx*4,0));
    display.drawLine(xx+14,11,xx+14,15,display.color565(0,0,xx*4+4));
  }
